<template>
  <el-dialog v-model="dialogFormVisible"  width="500">
    <div class="dialog-content">
      <b class="title">居民疏散</b>
      <el-divider class="divider"></el-divider>
      <b class="Description">分析缓冲区内居民点并通知居民撤离</b>

      <img src="@/assets/scope.svg" alt="模型图片" class="model-image"/>

    </div>
    <template #footer>
      <div class="dialog-footer">
        <el-button @click="dialogFormVisible = false">取消</el-button>
        <el-button type="primary" @click="evacuateShow = true;BufferShow = false;isShow = false;dispatchShow = false;dialogFormVisible = false">确认</el-button>
      </div>
    </template>
  </el-dialog>
</template>
